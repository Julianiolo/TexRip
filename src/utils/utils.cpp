...
Eigen::Matrix<double, 3, 3> utils::get_homography_E(const Eigen::Matrix<double, 4, 2>& src_pts, const Eigen::Matrix<double, 4, 2>& dst_pts) //https://medium.com/all-things-about-robotics-and-computer-vision/homography-and-how-to-calculate-it-8abf3a13ddc5
{
